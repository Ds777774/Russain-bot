...
client.on('messageCreate', async (message) => {
    if (message.content.toLowerCase() === '!quiz') {
        ...
        try {
            ...
            await languageMessage.delete(); // Delete the language selection message after response
            ...
            await levelMessage.delete(); // Delete the level selection message after response
