...
const wordList = [
  ...
  { word: 'письмо', meaning: 'Letter', plural: 'письма', indefinite: 'письмо' },
  { word: 'река', meaning: 'River', plural: 'реки', indefinite: 'река' },
  { word: 'лес', meaning: 'Forest', plural: 'леса', indefinite: 'лес' },
  { word: 'цветок', meaning: 'Flower', plural: 'цветы', indefinite: 'цветок' },
  { word: 'трава', meaning: 'Grass', plural: 'травы', indefinite: 'трава' },
  { word: 'камера', meaning: 'Camera', plural: 'камеры', indefinite: 'камера' },
  { word: 'окно', meaning: 'Window', plural: 'окна', indefinite: 'окно' },
  { word: 'поток', meaning: 'Stream', plural: 'потоки', indefinite: 'поток' },
  { word: 'поезд', meaning: 'Train', plural: 'поезда', indefinite: 'поезд' },
  { word: 'площадь', meaning: 'Square', plural: 'площади', indefinite: 'площадь' },
  { word: 'улица', meaning: 'Street', plural: 'улицы', indefinite: 'улица' },
  { word: 'жизнь', meaning: 'Life', plural: 'жизни', indefinite: 'жизнь' },
  { word: 'выход', meaning: 'Exit', plural: 'выходы', indefinite: 'выход' },
  { word: 'вход', meaning: 'Entrance', plural: 'входы', indefinite: 'вход' },
  { word: 'север', meaning: 'North', plural: 'севера', indefinite: 'север' },
  { word: 'юг', meaning: 'South', plural: 'юга', indefinite: 'юг' },
  { word: 'восток', meaning: 'East', plural: 'востоки', indefinite: 'восток' },
  { word: 'запад', meaning: 'West', plural: 'запады', indefinite: 'запад' },
  { word: 'солнце', meaning: 'Sun', plural: 'солнца', indefinite: 'солнце' },
  { word: 'лёд', meaning: 'Ice', plural: 'лёды', indefinite: 'лёд' },
  { word: 'дождь', meaning: 'Rain', plural: 'дожди', indefinite: 'дождь' },
  { word: 'снег', meaning: 'Snow', plural: 'снега', indefinite: 'снег' },
  { word: 'погода', meaning: 'Weather', plural: 'погоды', indefinite: 'погода' },
  { word: 'температура', meaning: 'Temperature', plural: 'температуры', indefinite: 'температура' },
  { word: 'сухой', meaning: 'Dry', plural: 'сухие', indefinite: 'сухой' },
  { word: 'мокрый', meaning: 'Wet', plural: 'мокрые', indefinite: 'мокрый' },
  { word: 'теплый', meaning: 'Warm', plural: 'теплые', indefinite: 'теплый' },
  { word: 'холодный', meaning: 'Cold', plural: 'холодные', indefinite: 'холодный' },
  { word: 'красный', meaning: 'Red', plural: 'красные', indefinite: 'красный' },
  { word: 'синий', meaning: 'Blue', plural: 'синие', indefinite: 'синий' },
  { word: 'зеленый', meaning: 'Green', plural: 'зеленые', indefinite: 'зеленый' },
  { word: 'жёлтый', meaning: 'Yellow', plural: 'жёлтые', indefinite: 'жёлтый' },
  { word: 'черный', meaning: 'Black', plural: 'черные', indefinite: 'черный' },
  { word: 'белый', meaning: 'White', plural: 'белые', indefinite: 'белый' },
  { word: 'серый', meaning: 'Gray', plural: 'серые', indefinite: 'серый' },
  { word: 'оранжевый', meaning: 'Orange', plural: 'оранжевые', indefinite: 'оранжевый' },
  { word: 'пурпурный', meaning: 'Purple', plural: 'пурпурные', indefinite: 'пурпурный' },
  { word: 'розовый', meaning: 'Pink', plural: 'розовые', indefinite: 'розовый' },
  { word: 'голубой', meaning: 'Sky Blue', plural: 'голубые', indefinite: 'голубой' },
  { word: 'коричневый', meaning: 'Brown', plural: 'коричневые', indefinite: 'коричневый' },
  { word: 'слово', meaning: 'Word', plural: 'слова', indefinite: 'слово' },
  { word: 'предложение', meaning: 'Sentence', plural: 'предложения', indefinite: 'предложение' },
  { word: 'книга', meaning: 'Book', plural: 'книги', indefinite: 'книга' },
  { word: 'газета', meaning: 'Newspaper', plural: 'газеты', indefinite: 'газета' },
  { word: 'зеркало', meaning: 'Mirror', plural: 'зеркала', indefinite: 'зеркало' },
  { word: 'дерево', meaning: 'Tree', plural: 'деревья', indefinite: 'дерево' },
  { word: 'цвет', meaning: 'Color', plural: 'цвета', indefinite: 'цвет' },
  { word: 'песок', meaning: 'Sand', plural: 'пески', indefinite: 'песок' },
  { word: 'горы', meaning: 'Mountains', plural: 'горы', indefinite: 'гора' },
  { word: 'площадка', meaning: 'Platform', plural: 'площадки', indefinite: 'площадка' },
  { word: 'порой', meaning: 'Sometimes', plural: 'порой', indefinite: 'порой' },
  { word: 'звезда', meaning: 'Star', plural: 'звезды', indefinite: 'звезда' },
  { word: 'ночное небо', meaning: 'Night Sky', plural: 'ночные небеса', indefinite: 'ночное небо' },
  { word: 'памятник', meaning: 'Monument', plural: 'памятники', indefinite: 'памятник' },
  { word: 'здание', meaning: 'Building', plural: 'здания', indefinite: 'здание' },
  { word: 'камера', meaning: 'Camera', plural: 'камеры', indefinite: 'камера' },
  { word: 'музей', meaning: 'Museum', plural: 'музеи', indefinite: 'музей' },
  { word: 'театр', meaning: 'Theater', plural: 'театры', indefinite: 'театр' },
  { word: 'ресторан', meaning: 'Restaurant', plural: 'рестораны', indefinite: 'ресторан' },
  { word: 'парк', meaning: 'Park', plural: 'парки', indefinite: 'парк' },
  { word: 'игра', meaning: 'Game', plural: 'игры', indefinite: 'игра' },
  { word: 'песня', meaning: 'Song', plural: 'песни', indefinite: 'песня' },
  { word: 'танец', meaning: 'Dance', plural: 'танцы', indefinite: 'танец' },
  { word: 'спорт', meaning: 'Sport', plural: 'спорты', indefinite: 'спорт' },
  { word: 'часы', meaning: 'Clock', plural: 'часы', indefinite: 'часы' },
  { word: 'молоко', meaning: 'Milk', plural: 'молока', indefinite: 'молоко' },
  { word: 'хлеб', meaning: 'Bread', plural: 'хлебы', indefinite: 'хлеб' },
  { word: 'масло', meaning: 'Butter', plural: 'масла', indefinite: 'масло' },
  { word: 'сахар', meaning: 'Sugar', plural: 'сахара', indefinite: 'сахар' },
  { word: 'помидор', meaning: 'Tomato', plural: 'помидоры', indefinite: 'помидор' },
  { word: 'огурец', meaning: 'Cucumber', plural: 'огурцы', indefinite: 'огурец' },
  { word: 'морковь', meaning: 'Carrot', plural: 'моркови', indefinite: 'морковь' },
  { word: 'яблоко', meaning: 'Apple', plural: 'яблоки', indefinite: 'яблоко' },
  { word: 'груша', meaning: 'Pear', plural: 'груши', indefinite: 'груша' },
  { word: 'банан', meaning: 'Banana', plural: 'бананы', indefinite: 'банан' },
  { word: 'гриб', meaning: 'Mushroom', plural: 'грибы', indefinite: 'гриб' },
  { word: 'картофель', meaning: 'Potato', plural: 'картофели', indefinite: 'картофель' },
  { word: 'соль', meaning: 'Salt', plural: 'соли', indefinite: 'соль' },
  { word: 'перец', meaning: 'Pepper', plural: 'перцы', indefinite: 'перец' },
  { word: 'птица', meaning: 'Bird', plural: 'птицы', indefinite: 'птица' },
  { word: 'зверь', meaning: 'Beast', plural: 'звери', indefinite: 'зверь' },
  { word: 'собака', meaning: 'Dog', plural: 'собаки', indefinite: 'собака' },
  { word: 'кошка', meaning: 'Cat', plural: 'кошки', indefinite: 'кошка' },
  { word: 'рыба', meaning: 'Fish', plural: 'рыбы', indefinite: 'рыба' },
  { word: 'конь', meaning: 'Horse', plural: 'кони', indefinite: 'конь' }
]; 
