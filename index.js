...
  { word: 'облако', meaning: 'Cloud', options: ['A: Snow', 'B: Cloud', 'C: Rain', 'D: Sun'], correct: '🇧' },  { word: 'солнце', meaning: 'Sun', options: ['A: Sun', 'B: Rain', 'C: Fog', 'D: Cloud'], correct: '🇦' },
...
  { word: 'реконструкция', meaning: 'Reconstruction', options: ['A: Renovation', 'B: Repair', 'C: Reconstruction', 'D: Refurbishment'], correct: '🇩' },  { word: 'квазимиф', meaning: 'Quasimyth', options: ['A: Fiction', 'B: Allegory', 'C: Quasimyth', 'D: Fantasy'], correct: '🇨' },
