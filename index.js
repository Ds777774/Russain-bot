...
const wordList = [
  { word: 'город', meaning: 'City', plural: 'города', indefinite: 'один город', definite: 'этот город' },
  { word: 'яблоко', meaning: 'Apple', plural: 'яблоки', indefinite: 'одно яблоко', definite: 'это яблоко' },
  { word: 'книга', meaning: 'Book', plural: 'книги', indefinite: 'одна книга', definite: 'эта книга' },
  { word: 'собака', meaning: 'Dog', plural: 'собаки', indefinite: 'одна собака', definite: 'эта собака' },
  { word: 'кот', meaning: 'Cat', plural: 'коты', indefinite: 'один кот', definite: 'этот кот' },
  { word: 'человек', meaning: 'Person', plural: 'люди', indefinite: 'один человек', definite: 'этот человек' },
  { word: 'стол', meaning: 'Table', plural: 'столы', indefinite: 'один стол', definite: 'этот стол' },
  { word: 'кресло', meaning: 'Armchair', plural: 'кресла', indefinite: 'одно кресло', definite: 'это кресло' },
  { word: 'дерево', meaning: 'Tree', plural: 'деревья', indefinite: 'одно дерево', definite: 'это дерево' },
  { word: 'машина', meaning: 'Car', plural: 'машины', indefinite: 'одна машина', definite: 'эта машина' },
  { word: 'здание', meaning: 'Building', plural: 'здания', indefinite: 'одно здание', definite: 'это здание' },
  { word: 'окно', meaning: 'Window', plural: 'окна', indefinite: 'одно окно', definite: 'это окно' },
  { word: 'дверь', meaning: 'Door', plural: 'двери', indefinite: 'одна дверь', definite: 'эта дверь' },
  { word: 'кровать', meaning: 'Bed', plural: 'кровати', indefinite: 'одна кровать', definite: 'эта кровать' },
  { word: 'сумка', meaning: 'Bag', plural: 'сумки', indefinite: 'одна сумка', definite: 'эта сумка' },
  { word: 'телефон', meaning: 'Phone', plural: 'телефоны', indefinite: 'один телефон', definite: 'этот телефон' },
  { word: 'компьютер', meaning: 'Computer', plural: 'компьютеры', indefinite: 'один компьютер', definite: 'этот компьютер' },
  { word: 'телевизор', meaning: 'TV', plural: 'телевизоры', indefinite: 'один телевизор', definite: 'этот телевизор' },
  { word: 'письмо', meaning: 'Letter', plural: 'письма', indefinite: 'одно письмо', definite: 'это письмо' },
  { word: 'картина', meaning: 'Painting', plural: 'картины', indefinite: 'одна картина', definite: 'эта картина' },
  { word: 'фото', meaning: 'Photo', plural: 'фото', indefinite: 'одно фото', definite: 'это фото' },
  { word: 'груша', meaning: 'Pear', plural: 'груши', indefinite: 'одна груша', definite: 'эта груша' },
  { word: 'виноград', meaning: 'Grapes', plural: 'виноград', indefinite: 'один виноград', definite: 'этот виноград' },
  { word: 'солнце', meaning: 'Sun', plural: 'солнца', indefinite: 'одно солнце', definite: 'это солнце' },
  { word: 'небо', meaning: 'Sky', plural: 'небеса', indefinite: 'одно небо', definite: 'это небо' },
  { word: 'облако', meaning: 'Cloud', plural: 'облака', indefinite: 'одно облако', definite: 'это облако' },
  { word: 'птица', meaning: 'Bird', plural: 'птицы', indefinite: 'одна птица', definite: 'эта птица' },
  { word: 'рыба', meaning: 'Fish', plural: 'рыбы', indefinite: 'одна рыба', definite: 'эта рыба' },
  { word: 'морковь', meaning: 'Carrot', plural: 'моркови', indefinite: 'одна морковь', definite: 'эта морковь' },
  { word: 'помидор', meaning: 'Tomato', plural: 'помидоры', indefinite: 'один помидор', definite: 'этот помидор' },
  { word: 'огурец', meaning: 'Cucumber', plural: 'огурцы', indefinite: 'один огурец', definite: 'этот огурец' },
  { word: 'соль', meaning: 'Salt', plural: 'соли', indefinite: 'одна соль', definite: 'эта соль' },
  { word: 'сахар', meaning: 'Sugar', plural: 'сахар', indefinite: 'один сахар', definite: 'этот сахар' },
  { word: 'молоко', meaning: 'Milk', plural: 'молока', indefinite: 'одно молоко', definite: 'это молоко' },
  { word: 'хлеб', meaning: 'Bread', plural: 'хлебы', indefinite: 'один хлеб', definite: 'этот хлеб' },
  { word: 'суп', meaning: 'Soup', plural: 'супы', indefinite: 'один суп', definite: 'этот суп' },
  { word: 'мясо', meaning: 'Meat', plural: 'мяса', indefinite: 'одно мясо', definite: 'это мясо' },
  { word: 'рыбак', meaning: 'Fisherman', plural: 'рыбаки', indefinite: 'один рыбак', definite: 'этот рыбак' },
  { word: 'письменность', meaning: 'Writing', plural: 'письменности', indefinite: 'одна письменность', definite: 'эта письменность' },
  { word: 'чашка', meaning: 'Cup', plural: 'чашки', indefinite: 'одна чашка', definite: 'эта чашка' },
  { word: 'пакет', meaning: 'Bag', plural: 'пакеты', indefinite: 'один пакет', definite: 'этот пакет' },
  { word: 'коробка', meaning: 'Box', plural: 'коробки', indefinite: 'одна коробка', definite: 'эта коробка' },
  { word: 'интернет', meaning: 'Internet', plural: 'интернеты', indefinite: 'один интернет', definite: 'этот интернет' },
  { word: 'вода', meaning: 'Water', plural: 'воды', indefinite: 'одна вода', definite: 'эта вода' },
  { word: 'воздух', meaning: 'Air', plural: 'воздухи', indefinite: 'один воздух', definite: 'этот воздух' },
  { word: 'свет', meaning: 'Light', plural: 'светы', indefinite: 'один свет', definite: 'этот свет' },
  { word: 'тень', meaning: 'Shadow', plural: 'тени', indefinite: 'одна тень', definite: 'эта тень' },
  { word: 'песня', meaning: 'Song', plural: 'песни', indefinite: 'одна песня', definite: 'эта песня' },
  { word: 'музыка', meaning: 'Music', plural: 'музыки', indefinite: 'одна музыка', definite: 'эта музыка' },
  { word: 'сказка', meaning: 'Fairy Tale', plural: 'сказки', indefinite: 'одна сказка', definite: 'эта сказка' },
  { word: 'работа', meaning: 'Work', plural: 'работы', indefinite: 'одна работа', definite: 'эта работа' },
  { word: 'друзья', meaning: 'Friends', plural: 'друзья', indefinite: 'один друг', definite: 'этот друг' },
  { word: 'деньги', meaning: 'Money', plural: 'деньги', indefinite: 'одни деньги', definite: 'эти деньги' },
  { word: 'счастье', meaning: 'Happiness', plural: 'счастья', indefinite: 'одно счастье', definite: 'это счастье' },
  { word: 'любовь', meaning: 'Love', plural: 'любви', indefinite: 'одна любовь', definite: 'эта любовь' },
  { word: 'жизнь', meaning: 'Life', plural: 'жизни', indefinite: 'одна жизнь', definite: 'эта жизнь' },
  { word: 'смерть', meaning: 'Death', plural: 'смерти', indefinite: 'одна смерть', definite: 'эта смерть' },
  { word: 'голова', meaning: 'Head', plural: 'головы', indefinite: 'одна голова', definite: 'эта голова' },
  { word: 'рука', meaning: 'Hand', plural: 'руки', indefinite: 'одна рука', definite: 'эта рука' },
  { word: 'нога', meaning: 'Leg', plural: 'ноги', indefinite: 'одна нога', definite: 'эта нога' },
  { word: 'глаз', meaning: 'Eye', plural: 'глаза', indefinite: 'один глаз', definite: 'этот глаз' },
  { word: 'ухо', meaning: 'Ear', plural: 'уши', indefinite: 'одно ухо', definite: 'это ухо' },
  { word: 'нос', meaning: 'Nose', plural: 'носы', indefinite: 'один нос', definite: 'этот нос' },
  { word: 'язык', meaning: 'Tongue', plural: 'языки', indefinite: 'один язык', definite: 'этот язык' },
  { word: 'зуб', meaning: 'Tooth', plural: 'зубы', indefinite: 'один зуб', definite: 'этот зуб' },
  { word: 'кожа', meaning: 'Skin', plural: 'кожи', indefinite: 'одна кожа', definite: 'эта кожа' },
  { word: 'сердце', meaning: 'Heart', plural: 'сердца', indefinite: 'одно сердце', definite: 'это сердце' },
  { word: 'мозг', meaning: 'Brain', plural: 'мозги', indefinite: 'один мозг', definite: 'этот мозг' },
  { word: 'кровь', meaning: 'Blood', plural: 'крови', indefinite: 'одна кровь', definite: 'эта кровь' },
  { word: 'позвонок', meaning: 'Vertebra', plural: 'позвонки', indefinite: 'один позвонок', definite: 'этот позвонок' },
  { word: 'кость', meaning: 'Bone', plural: 'кости', indefinite: 'одна кость', definite: 'эта кость' },
  { word: 'мышца', meaning: 'Muscle', plural: 'мышцы', indefinite: 'одна мышца', definite: 'эта мышца' },
  { word: 'сила', meaning: 'Strength', plural: 'силы', indefinite: 'одна сила', definite: 'эта сила' },
  { word: 'телосложение', meaning: 'Body Type', plural: 'телосложения', indefinite: 'одно телосложение', definite: 'это телосложение' },
  { word: 'краска', meaning: 'Paint', plural: 'краски', indefinite: 'одна краска', definite: 'эта краска' },
  { word: 'ткань', meaning: 'Fabric', plural: 'ткани', indefinite: 'одна ткань', definite: 'эта ткань' },
  { word: 'цвет', meaning: 'Color', plural: 'цвета', indefinite: 'один цвет', definite: 'этот цвет' },
  { word: 'формула', meaning: 'Formula', plural: 'формулы', indefinite: 'одна формула', definite: 'эта формула' },
  { word: 'число', meaning: 'Number', plural: 'числа', indefinite: 'одно число', definite: 'это число' },
  { word: 'размер', meaning: 'Size', plural: 'размеры', indefinite: 'один размер', definite: 'этот размер' },
  { word: 'форма', meaning: 'Shape', plural: 'формы', indefinite: 'одна форма', definite: 'эта форма' },
  { word: 'металл', meaning: 'Metal', plural: 'металлы', indefinite: 'один металл', definite: 'этот металл' },
  { word: 'дерево', meaning: 'Wood', plural: 'деревья', indefinite: 'одно дерево', definite: 'это дерево' },
  { word: 'камень', meaning: 'Stone', plural: 'камни', indefinite: 'один камень', definite: 'этот камень' },
  { word: 'река', meaning: 'River', plural: 'реки', indefinite: 'одна река', definite: 'эта река' },
  { word: 'озеро', meaning: 'Lake', plural: 'озера', indefinite: 'одно озеро', definite: 'это озеро' },
